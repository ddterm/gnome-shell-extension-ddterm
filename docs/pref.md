...
These scripts need some files generated by the build system (at least a compiled
GSettings schema), and must be ran from the build directory:

    ninja -C build-dir prefs-gtk3-test
    ninja -C build-dir prefs-gtk4-test
