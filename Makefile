...
SYS_INSTALLED_DBUS_SERVICE := $(DESTDIR)$(datadir)/dbus-1/services/com.github.amezin.ddterm.service
...
$(SYS_INSTALLED_DESKTOP_ENTRY) $(SYS_INSTALLED_DBUS_SERVICE): | installdirs
	$(INSTALL_DATA) $< $@

$(SYS_INSTALLED_DESKTOP_ENTRY): $(CONFIGURED_DESKTOP_ENTRY)
$(SYS_INSTALLED_DBUS_SERVICE): $(CONFIGURED_DBUS_SERVICE)

system-install: $(SYS_INSTALLED_CONTENT) $(SYS_INSTALLED_DESKTOP_ENTRY) $(SYS_INSTALLED_DBUS_SERVICE)

system-uninstall:
	$(RM) -r $(SYS_INSTALLED_FULL_PREFIX) $(SYS_INSTALLED_DESKTOP_ENTRY) $(SYS_INSTALLED_DBUS_SERVICE)
