...
exit_code=0
do_in_pod gdbus call --session --timeout 1000 --dest org.gnome.Shell --object-path /org/gnome/Shell/Extensions/ddterm --method com.github.amezin.ddterm.ExtensionTest.RunTest "${TEST_FILTER}" "${TEST_FILTER_OUT}" || exit_code=$?
